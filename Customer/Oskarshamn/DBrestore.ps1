...
$file = 'D:\Visma\DB_Migration\DBRestore.XML'
...
Invoke-DbaQuery -SqlInstance $SQLTEST -Database $UsersDB -Query "update dbo.Company SET [Description] = [Description]+' TEST'" -Verbose -SqlCredential $cred
